...
3. LOCALISATION ET DYNAMIQUE DE MARCHÉ — présente les transactions DVF et les annonces comparables (Castorus) collectées, sous forme de tableau si tu as au moins 3 points de comparaison. Conclus sur la liquidité et l'attractivité du secteur pour un acheteur pro.
...
6. FOURCHETTE DE PRIX ESTIMÉE — à partir des données DVF/marché collectées, estime une fourchette basse/haute avec le composant estimation-grid. Si les données de marché sont insuffisantes, indique-le explicitement dans une box-gold plutôt que d'inventer des chiffres.
