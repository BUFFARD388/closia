...
export async function POST(req: NextRequest) {
  try {
    ...
    const dossierUrl = `${process.env.NEXT_PUBLIC_APP_URL}/cub/dossier/${analyseId}`
        ...
        <div style="font-family:Arial,Helvetica,sans-serif;max-width:600px;margin:0 auto;background:#0b1220;color:#fff;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:36px 48px;">
            ...
            <div style="background:#111720;border:1px solid rgba(194,154,107,0.25);border-radius:10px;padding:18px 20px;margin-bottom:28px;">
              <p style="color:#c29a6b;font-size:10px;text-transform:uppercase;letter-spacing:1.5px;margin:0 0 12px;font-weight:700;">Votre dossier comprend</p>
              <p style="color:#d1d5db;font-size:13px;margin:0 0 8px;">✓ <strong style="color:#c29a6b;">Note descriptive du projet</strong> — prête à insérer dans le CERFA 13410</p>
              <p style="color:#d1d5db;font-size:13px;margin:0 0 8px;">✓ <strong style="color:#60a5fa;">Check-list des pièces à joindre</strong> — personnalisée pour votre projet</p>
              <p style="color:#d1d5db;font-size:13px;margin:0;">✓ <strong style="color:#34d399;">Guide de dépôt en mairie</strong> — délais, interlocuteurs, conseils pratiques</p>
            </div>

            <div style="text-align:center;margin-bottom:28px;">
              <a href="${dossierUrl}"
                style="display:inline-block;background:#c29a6b;color:#000;font-weight:700;padding:14px 32px;border-radius:10px;text-decoration:none;font-size:14px;text-transform:uppercase;letter-spacing:1.5px;">
                Consulter et télécharger mon dossier
              </a>
              <p style="color:#6b7280;font-size:11px;margin:12px 0 0;">
                Le bouton "Télécharger / Imprimer PDF" est disponible en haut de la page
              </p>
            </div>

            <div style="background:rgba(194,154,107,0.06);border:1px solid rgba(194,154,107,0.2);border-radius:8px;padding:14px 18px;">
              <p style="color:#c29a6b;font-size:13px;margin:0 0 4px;font-weight:600;">Besoin d'accompagnement ?</p>
              <p style="color:#9ca3af;font-size:12px;margin:0;">
                Contactez-nous à <a href="mailto:contact@closia.net" style="color:#c29a6b;">contact@closia.net</a>
