        ...
        <div className="bg-[#111720] border border-white/10 p-6 rounded-xl">
            ...
            <form onSubmit={e => { e.preventDefault(); setStep(2) }} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className="input" placeholder="Jean" required />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Nom *</label>
                  <input className="input" placeholder="Dupont" required />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Email professionnel *</label>
                <input type="email" className="input" placeholder="jean.dupont@societe.fr" required />
              </div>
              <div>
              ...
              <div>
                ...
                <input className="input" placeholder="Nom de votre société" required />
              </div>
              <div>
              ...
              <div>
                ...
                <input className="input" placeholder="Ex : Lyon, Rhône-Alpes, PACA…" />
              </div>
              <div>
          ...
          {step === 2 && (
            <div className="text-center py-6">
              ...
              <Link href="/dashboard/acheteur" className="btn-primary justify-center">
